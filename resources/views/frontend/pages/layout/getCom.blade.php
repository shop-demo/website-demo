<ul class="media-list">
	...
	<li class="media">
		...
		<div class="media-body">
			...
			<p>{{$value->comment}}</p>
			<form action="{{route('getComm')}}" method="post" class="form_reply_comm_{{$value->id}} formReply" style="display:none;">
				@csrf
				...
				<input type="hidden" value="{{route('getComm')}}" name="routePost" id="routeRep"/>
