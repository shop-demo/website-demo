  ...
  <table>
	...
	<tr>
		...
		<div class="input-group">
		    <input type="text" class="form-control" name="hinh_minh_hoa" id="hinh_minh_hoa" value="{{ old('hinh_minh_hoa')}}"/>
	...
	<tr>
		...
		<td>
		<div class="input-group">
		    <input type="text" class="form-control" name="album_anh" id="hinh_album" value="{{ old('album_anh')}}"/>
		    <span class="input-group-addon">
	...
	<tr>
  		<td><label for="price">Mô tả</label></td>
		<td><textarea type="text" class="form-control" name="mo_ta_ngan_gon" 
		 value="{{old('email')}}"></textarea></td>
	...
	<tr>
  		<td><label for="price">Chi tiết</label></td>
		<td><textarea type="text" class="form-control" name="mo_ta_chi_tiet" id="editor1"  value="{{old('mo_ta_chi_tiet')}}"></textarea></td>
	...
	<tr>
		...
		<select name="the_loai_id" class='form-control'>
			...
			@foreach(getTheloai_id_cha($dataTheLoai,$id_cha=0,$level=0) as $key=>$tl)
				
				<option value="{{$tl->id}}" {{ old('id_cha')== $tl->id ? 'selected' : false }}>{{str_repeat(' --- ',$tl->level).$tl->name}}</option>
